...
{    
    ...
    V3DD::DRAW_LINE("line", Eigen::Vector3d(-1, -1, -1), Eigen::Vector3d(0, 1, 2), vizkit3dDebugDrawings::Color::cyan);
    ...
    V3DD::COMPLEX_DRAWING([]()
    {
        ...
        V3DD::DRAW_AABB("Complex", boundingBox, vizkit3dDebugDrawings::Color::alloy_orange);
         V3DD::DRAW_SPHERE("Complex", -7, 1, 1, 1, vizkit3dDebugDrawings::Color::magenta);
    });
    ...
    while(true)
    {
        ...
        V3DD::DRAW_SPHERE("removeTest", blinkPos, 1, vizkit3dDebugDrawings::Color::air_force_blue_raf);
        V3DD::DRAW_SPHERE("remvoeTest2", Eigen::Vector3d(-4, -4, -4), 0.8, vizkit3dDebugDrawings::Color::cadmium_orange);
